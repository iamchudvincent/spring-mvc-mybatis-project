...
<head>
    ...
    <script src="${base}/static/js/angular/console-sham.js"></script>

    <script src="http://netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js"></script>

    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.5.6/angular.min.js"></script>
    <script type="text/javascript" src="${base}/static/js/angular/angular-file-upload.min.js"></script>
    <script type="text/javascript" src="${base}/static/js/angular/controllers.js"></script>

    <script type="text/javascript" src="${base}/static/js/angular/directives.js"></script>
    <!-- Angular JS Upload image -->
...
<div id="mContainer">
    <form name="contentFm" onsubmit="return checkForm()" method="post"
          action="${base}/admin/Feedback/add.html" id="contentFm"
                        ...
                        <div class="menublock" id="menublock">
                            <div class="nav">
                                <a href="javascript:" class="hover"
                                   style="left:0px;z-index:99;width:190px;background:url(${base}/static/image/common/title_hover_200.png)">Add
                                    Feedback</a>
                                <div class="clear"></div>
                            </div>
                        </div>
            ...
            <tr>
                <td class="content" id="tdcontent">
                    <div class="form" id="formblock">
                        <table cellspacing="0" cellpadding="5" width="100%" border="0">
                            <tr>
                                ...
                                <td>
                                    <input name="student_name" type="text" maxlength="100" id="student_name"
                                           class="Line" style="width:284px;height:28px;"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="student_type" id=student_type>
                                        ...
                                        <c:forEach items="${listStudentTypeModel }" var="stm">
                                            <option value="${stm.type_id }">${stm.type_name }</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <select name="course_type" id="drp_course_type_id">
                                        ...
                                        <c:forEach items="${listCourseTypeModel }" var="ctm">
                                            <option value="${ctm.course_id }">${ctm.cource_name }</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <select name="country_id" id="drp_country_from">
                                        ...
                                        <c:forEach items="${listCountryModel }" var="cm">
                                            <option value="${cm.country_id }">${cm.country_name }</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <select name="agency_id" id="drp_agency">
                                        ...
                                        <c:forEach items="${listAgenciesModel }" var="agm">
                                            <option value="${agm.agency_id }">${agm.simple_name }</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input style="width:484px;height:28px;" id="purpose_id" type="text" name="purpose"
                                           class="Line"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input style="width:280px;" type="text" id="study_date" name="study_date"
                                           data-options="panelWidth:280,height:28,formatter:myformatter,parser:myparser"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input style="width:280px;" type="text" id="interview_date" name="interview_date"
                                           data-options="panelWidth:280,height:28,formatter:myformatter,parser:myparser"
                                           class="easyui-datebox"/>
                                    <script type="text/javascript">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="title" type="text" maxlength="100"
                                           style="height:28px;width:482px;font-weight:bold;" id="title_id"
                                           class="ruler_line" style="width: 440px;"/>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellspacing="0" cellpadding="5" width="94%" border="0">
                            <tr>
                                <td valign="top" colspan="2">
                                    <div class="tab" style="position: relative; margin-bottom: 5px">
                                        <a href="javascript:" class="hover"><span class="l"></span>
                                            <span id="images_lblTitle" style="padding: 0 5px">Profile Image(Support for 1 picture file only)</span>
                                            <span class="r"></span></a>
                                        <div class="clear"></div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr id="images_upload_tips_id" bgcolor="#ffffff">
                                            <td style="font-size:15px;">Tips：If you want to show profile picture,please
                                                select a picture and upload.
                                                <font color="red">Size:(width:208px,Height:255px)</font>
                                            </td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr ng-repeat="item in uploader.queue">
                                            ...
                                            <td class="text-center" id="uploaded_when" name="uploaded_when"></td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <textarea name="content" id="txt_content_id"
                              style="height: 390px; width: 100%; word-wrap: break-word; visibility: hidden;"></textarea>
                            </td>
                        </tr>
                    </table>
                    <div id="jspForm_Panel_ShowReplay" style="width: 99%;"></div>
...
<script type="text/javascript">
    ...
    function checkForm() {
        if (student_name_id() == false || check_student_type() == false || check_course_type_id() == false || check_drp_from_city() == false || check_txt_purpose() == false || check_study_date() == false || check_interview_date() == false || check_title() == false || check_content() == false || check_drp_country_from() == false || check_drp_agency() == false) {
            return false;
        } else {
            return true;
        }
